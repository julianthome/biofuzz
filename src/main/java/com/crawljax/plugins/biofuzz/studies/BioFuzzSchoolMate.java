...
public class BioFuzzSchoolMate {
	
	private static final Logger logger = LoggerFactory.getLogger(BioFuzzSchoolMate.class);
	private static BioFuzzInputSpecIface ispec = null;

	public static void main(String[] args) {
		
		ispec = new SchoolMateInputSpec();
		...
		CrawljaxConfigurationBuilder builder = BioFuzzUtils.getConfigBuilderFor("http://localhost/schoolmate", ispec, plugin);
